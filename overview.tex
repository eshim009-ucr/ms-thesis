...
% As a precursor, you need to describe Ziegler's design in some amount of detail. You'll need to tie it to earlier discussions of the B-Link tree, database indexing, and RDMA. We can then move on to a discussion of your implementation of it.
