...
existing software solutions to converted for deployment on FPGAs. We propose a
novel database architecture which uses an HLS design running on an FPGA running
as the sole processing element for in-memory key-value store based on
\citeauthor{base}'s implementation of \citeauthor{b-link}'s B-Link tree.
\end{abstract}
