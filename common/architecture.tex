...
Though FPGAs still have a memory heirarchy as shown in
\autoref{fig:memory-heirarchy}, it functions differently to that of a CPU.

\begin{figure}
	\input{tikz/memory-heirarchy}
	\caption{Memory Heirarchy Comparison}
